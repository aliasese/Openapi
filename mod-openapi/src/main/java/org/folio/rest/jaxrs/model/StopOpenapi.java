...
public class StopOpenapi {
    ...
    public StopOpenapi withLog(Log log) {
        this.log = log;
        return this;
    }
    ...
    public StopOpenapi withOpenapiIdArray(List<String> openapiIdArray) {
        this.openapiIdArray = openapiIdArray;
        return this;
    }
    ...
    public StopOpenapi withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
}
