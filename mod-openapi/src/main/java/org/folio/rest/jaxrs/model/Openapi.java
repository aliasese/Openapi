...
@JsonPropertyOrder({ "id", "onlineSrvcId", "name", "method", "summary", "catalog", "type", "visit_url", "visit_test_url", "publish_url", "deploy_url", "publish_test_url", "deploy_test_url", "common_params", "private_params", "outputs", "status", "create_time", "update_time" })
public class Openapi {
    ...
    public Openapi withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Openapi withOnlineSrvcId(String onlineSrvcId) {
        this.onlineSrvcId = onlineSrvcId;
        return this;
    }
    ...
    public Openapi withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Openapi withMethod(List<String> method) {
        this.method = method;
        return this;
    }
    ...
    public Openapi withSummary(String summary) {
        this.summary = summary;
        return this;
    }
    ...
    public Openapi withCatalog(String catalog) {
        this.catalog = catalog;
        return this;
    }
    ...
    public Openapi withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Openapi withVisitUrl(String visitUrl) {
        this.visitUrl = visitUrl;
        return this;
    }
    ...
    public Openapi withVisitTestUrl(String visitTestUrl) {
        this.visitTestUrl = visitTestUrl;
        return this;
    }
    ...
    public Openapi withPublishUrl(String publishUrl) {
        this.publishUrl = publishUrl;
        return this;
    }
    ...
    public Openapi withDeployUrl(String deployUrl) {
        this.deployUrl = deployUrl;
        return this;
    }
    ...
    public Openapi withPublishTestUrl(String publishTestUrl) {
        this.publishTestUrl = publishTestUrl;
        return this;
    }
    ...
    public Openapi withDeployTestUrl(String deployTestUrl) {
        this.deployTestUrl = deployTestUrl;
        return this;
    }
    ...
    public Openapi withCommonParams(List<CommonParam> commonParams) {
        this.commonParams = commonParams;
        return this;
    }
    ...
    public Openapi withPrivateParams(List<CommonParam> privateParams) {
        this.privateParams = privateParams;
        return this;
    }
    ...
    public Openapi withOutputs(List<CommonParam> outputs) {
        this.outputs = outputs;
        return this;
    }
    ...
    public Openapi withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public Openapi withCreateTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
    ...
    public Openapi withUpdateTime(String updateTime) {
        this.updateTime = updateTime;
        return this;
    }
    ...
    public Openapi withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
}
